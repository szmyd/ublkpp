...
class LibUBlkSrvConan(ConanFile):
    name = "ublksrv"
    ...
    def source(self):
        ...
        if self.version == "nbi.1.4.1":
            replace_in_file(self, join(self.source_folder, "Makefile.am"), "$(PTHREAD_LIBS)", "$(PTHREAD_LIBS) -lstdc++")
    ...
    def generate(self):
        ...
        e.append("LIBURING_LIBS", "-luring".format(self.dependencies['liburing'].package_folder))
        e.append("LIBURING_CFLAGS", "-I{}/include".format(self.dependencies['liburing'].package_folder))
