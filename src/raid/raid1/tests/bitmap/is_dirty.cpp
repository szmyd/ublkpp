...
TEST(Raid1, DoesNotCrossPage) {
    ...
    {
        auto [pg, pg_off, sz] = bitmap.dirty_page(ublkpp::Gi - (4 * Ki), 12 * Ki);
        EXPECT_EQ(0U, pg_off);
        EXPECT_EQ(4 * Ki, sz);
    }
...
TEST(Raid1, BufferedIoTest) {
    auto bitmap = ublkpp::raid1::Bitmap(2 * ublkpp::Gi, 32 * Ki, 4 * Ki);
    {
        auto [pg, pg_off, sz] = bitmap.dirty_page(0xf7b000, 512 * Ki);
        EXPECT_EQ(0U, pg_off);
        EXPECT_EQ(512 * Ki, sz);
    }
    {
        auto [pg, pg_off, sz] = bitmap.dirty_page(0xffb000, 512 * Ki);
    ...
    {
        auto [pg, pg_off, sz] = bitmap.dirty_page(0x22ac000, 512 * Ki);
        EXPECT_TRUE(pg != nullptr);
        EXPECT_EQ(0U, pg_off);
        EXPECT_EQ(512 * Ki, sz);
    }
    {
        auto [pg, pg_off, sz] = bitmap.dirty_page(0x232c000, 312 * Ki);
        EXPECT_TRUE(pg != nullptr);
        EXPECT_EQ(0U, pg_off);
        EXPECT_EQ(312 * Ki, sz);
    }
    {
        auto [pg, pg_off, sz] = bitmap.dirty_page(0x237a000, 512 * Ki);
        EXPECT_TRUE(pg != nullptr);
        EXPECT_EQ(0U, pg_off);
        EXPECT_EQ(512 * Ki, sz);
    }
    {
        auto [pg, pg_off, sz] = bitmap.dirty_page(0x23fa000, 512 * Ki);
        EXPECT_TRUE(pg != nullptr);
        EXPECT_EQ(0U, pg_off);
        EXPECT_EQ(512 * Ki, sz);
    }
