...
#pragma pack()
    ...
    [[nodiscard]] bool __cas_state(resync_state& expected, resync_state desired) noexcept {
...
public:
    ...
    inline void enqueue_write() noexcept {
        ...
        // Ignore result, we can see we changed the value unconditionally in our
        // lambda
    ...
    inline void dequeue_write() noexcept {
        ...
        // We don't react if the state changed here, this WRITE done callback.
